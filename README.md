...
```
cd existing_repo
git remote add origin https://gitlab.com/ouralapak/ouralapak-frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ouralapak/ouralapak-frontend/-/settings/integrations)
