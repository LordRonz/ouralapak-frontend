...
const Content = ({ title }: { title: React.ReactNode }) => (
  <div>
    <div className='container mx-auto'>
      <div className='py-8'>
        <div className='mb-1 flex w-full flex-row flex-wrap justify-between sm:mb-0'>
          <h2 className='text-2xl leading-tight text-white md:pr-0'>{title}</h2>
          <div className='text-end'>
            <form className='flex w-full space-x-3'>
              ...
              <button
                className='flex-shrink-0 rounded-lg bg-gray-600 px-4 py-2 text-base font-semibold text-white shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200'
                type='submit'
              >
                Filter
              </button>
    ...
    <div className='flex-wrap items-center justify-center gap-8 text-center sm:flex'>
      ...
      <div className='mt-6 w-full rounded-lg bg-white px-4  py-4 shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 '>
        <div className='flex-shrink-0'>
          <div className='mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gray-600 text-white'>
            <svg
              width='20'
