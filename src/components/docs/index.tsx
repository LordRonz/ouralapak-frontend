  ...
  return (
    <div className='max-w-full py-8 text-gray-700'>
      ...
      <section className='mb-16 bg-white px-3 py-8 md:px-8'>
        ...
        <div className='mb-8'>
          ...
          <div className='mt-6 flex flex-wrap pl-6 md:flex-nowrap'>
            ...
            <p className='pl-1'>
              It{"'"}s in this file that you will add routes for each
              sidenav-item. it is an array of objects.
            </p>
          </div>
        ...
        <div>
          ...
          <div className='mt-4 flex flex-wrap pl-6 md:flex-nowrap'>
            ...
            <p className='pl-1'>
              ...
              customize it or replace it with your own navbar but don{"'"}t
      ...
      <section className='mb-16 bg-white px-3 py-8 md:px-8'>
        ...
        <p className='mt-5'>
          You can customize everything according to your preferences if it doesn
          {"'"}t suit you. What we have done is just provide a solid structure
      ...
      <section className='bg-white px-3 py-8 md:px-8'>
        ...
        <p className='mt-5'>
          ...
          <a
            ...
            className='px-1 font-medium text-blue-500'
          >
            Kimia-UI
          </a>
